    ...
    return (
        <div className="space-y-2">
            <div className="flex items-center justify-between border-b border-gray-100 pb-1.5">
                <h5 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Responsibilities & Achievements</h5>
                <button
                    type="button"
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
            ...
            {isEditing && (
                <div className="space-y-3 border-t border-gray-200 pt-3">
                    ...
                    {/* Date Range */}
                    <div className="space-y-2">
                        <h5 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-1">Employment Period</h5>
